...
import (
	...
	proto "github.com/dimpu47/advancedGoCloud/Communication/Go-Micro/proto"
...
func hello(t time.Time, greeter proto.GreeterClient) {
	// Call the greeter
	rsp, err := greeter.Hello(context.TODO(), &proto.HelloRequest{Name: "Gaurav, calling at " + t.String()})
	if err != nil {
